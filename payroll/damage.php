...
$natidd = $_POST['natid'];
$damges = $_POST['damount'];

$sql = "INSERT INTO damage(national_id, damag_amount, date_incurred, damag_status) VALUES('$natidd','$damges',now(),'unsettled') ";

$result = mysqli_query($conn, $sql);

if ($result) {
    echo  "<script> alert( ' DAMAGES RECORDED SUCCESSFULLY...') </script>";
} else {
...
<body>
  <div class="jumbotron text-center">
    <h1> payroll set damages amount </h1>
...
<label for="id number "><b>National ID:</b></label>
    ...
    <div>
      <label for="advance amount"><b>damage amount:</b></label>
          <input type="number" placeholder="Enter the advance amount " name="damount" required>
</div>
</div>
