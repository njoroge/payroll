...
class PDF extends FPDF
{
    ...
    public function Header()
    {
        ...
        $this->Cell(80);
        // Title
        $this->Cell(30, 10, 'Recorded net payment', 0, 0, 'C');
...
'lname' => 'last name', 'KRApin' => 'KRA PIN', 'tax_paid' => 'tax', 'net_pay'=>'net pay' ,'Date_processed' => 'date', );
...
foreach ($data as $key => $value) {
    ...
    $pdf->Cell(25, 10, $value['tax_paid'], 1);
    $pdf->Cell(30, 10, $value['net_pay'], 1);
