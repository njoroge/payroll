...
if(isset($_POST['submit'])){
    $bnksta= strtoupper($_POST['state']);
    $bnkname =$_POST['bank'];

    $sql= "SELECT *FROM banks WHERE  bnk_name ='$bnkname' AND bnk_status='$bnksta'";
    ...
    elseif($bnksta ==='ACTIVE'){
        $sql = "UPDATE banks SET bnk_status = 'ACTIVE' ";
        $result=mysqli_query($conn, $sql);
        if($result){
            echo "<script> alert('The state changed successfully') </script>";
        }
        else{
            echo "<script> alert('Failed!') </script>"; 
        }
    }
    elseif($bnksta ==='INACTIVE'){
        $sql = "UPDATE banks SET bnk_status = 'INACTIVE' ";
        $result=mysqli_query($conn, $sql);
        if($result){
            echo "<script> alert('The state changed successfully') </script>";
        }
