...
class PDF extends FPDF
{
    ...
    public function Header()
    {
        ...
        $this->Cell(80);
        // Title
        $this->Cell(30, 10, 'Recorded nhif contributions', 0, 0, 'C');
...
'lname' => 'last name', 'NHIFNO' => 'NHIF NO', 'nhif_deduct' => 'amount', 'Date_processed' => 'date', );
...
foreach ($data as $key => $value) {
    ...
    $pdf->Cell(30, 10, $value['NHIFNO'], 1);
    $pdf->Cell(30, 10, $value['nhif_deduct'], 1);
