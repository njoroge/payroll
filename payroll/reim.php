...
$iddna = $_POST['natid'];
$reimgg = $_POST['reimount'];

$sql = "INSERT INTO damage(national_id, reim_amount, reim_status, date_reim ) VALUES('$iddna','$reimgg','unsettled',now()) ";

$result = mysqli_query($conn, $sql);

if ($result) {
    echo  "<script> alert( ' REIMBURSEMENT RECORDED SUCCESSFULLY...') </script>";
} else {
...
<body>
  <div class="jumbotron text-center">
    <h1> reimbursement payment page </h1>
...
<label for="id number "><b>National ID:</b></label>
    ...
    <div>
      <label for="advance amount"><b>Reimbursement amount:</b></label>
          <input type="number" placeholder="Enter the advance amount " name="reimount" required>
</div>
</div>
