...
<body>
  <div class="jumbotron text-center">
    <h1>  NHIF contributions reports </h1>
  ...
  <div>
  <form action="nhifrepsgen.php" method="post">
      <h2>generate NHIF contribution reports</h2>
      <hr>
      <div class="form-row">
        <div class="col">
          <label for="start date"><b>Start date:</b></label>
          <input type="date" placeholder="start adte" name="date1" required>
        </div>
        <div class="col">
          <label for="end date"><b>End date:</b></label>
          <input type="date" placeholder="Enter the end date " name="date2" required>
        </div>
    ...
    <div class="container text-center text-md-left mt-5">
      <div class="row mt-3">
        ...
        <div class="col-md-2 col-lg-2 col-xl-2 mx-auto mb-4">
          ...
          <p>
            <a href="regdeparts.php">register department</a>
          </p>
        </div>
